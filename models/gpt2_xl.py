...
class GPT2Classification:
    ...
    def initialize_model(self):
        ...
        if self.from_pretrained:
            base_model_config = GPT2Config.from_pretrained(self.model_name, num_labels=self.num_labels)
            base_model = GPT2ForSequenceClassification.from_pretrained(self.model_name, config=base_model_config)
