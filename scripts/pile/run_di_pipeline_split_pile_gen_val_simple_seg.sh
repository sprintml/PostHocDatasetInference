#!/bin/bash
original_file_name="${doc_idx}_${n_tokens}token_max${max_snippets}_${sus_split}_random${n_tokens}_Meta-Llama-3-8B_simple_${doc_idx}_${n_tokens}token_max${max_snippets}_${train_split}_random${n_tokens}_${lora_epoch}.0epoch_${lora_rank}rank_${n_tokens}_0.5prefix_1"
paraphrase_file_name="${doc_idx}_${n_tokens}token_max${max_snippets}_${val_split}_random${n_tokens}_Meta-Llama-3-8B_simple_${doc_idx}_${n_tokens}token_max${max_snippets}_${train_split}_random${n_tokens}_${lora_epoch}.0epoch_${lora_rank}rank_${n_tokens}_0.5prefix_1"
original_short_name="${doc_idx}_${sus_split}_${n_tokens}token_max${max_snippets}_0.5prefix_${sus_column:0:4}"
paraphrase_short_name="${doc_idx}_${val_split}_${n_tokens}token_max${max_snippets}_0.5prefix_gen_val_sim_${lora_epoch}e_${lora_rank}r_${val_column:0:4}"
