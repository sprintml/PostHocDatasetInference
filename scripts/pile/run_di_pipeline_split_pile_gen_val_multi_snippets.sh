#!/bin/bash
original_file_name="${sus_split}_random${n_tokens}_Meta-Llama-3-8B_${train_split}_${n_tokens}token_max${max_snippets}_${lora_epoch}.0epoch_${lora_rank}rank_${n_tokens}_0.5prefix_1"
paraphrase_file_name="${val_split}_random${n_tokens}_Meta-Llama-3-8B_${train_split}_${n_tokens}token_max${max_snippets}_${lora_epoch}.0epoch_${lora_rank}rank_${n_tokens}_0.5prefix_1"
